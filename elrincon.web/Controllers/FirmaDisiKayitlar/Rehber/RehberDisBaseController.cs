...
{
    public class RehberDisBaseController : BaseController
    {

        public RehberDisEditorModel FillModel(int? id, string inputId)
        {
            RehberDisEditorModel modelEditor = new RehberDisEditorModel();
            ...
            modelMuhasebeGiderHesabi.Id = "rehber_editor_input_muhasebe_kodu" + inputId;
            ...
            if (id.HasValue && id > 0)
            {
                ...
                {
                    string tip = "1";
                    FillYuzdelikDefaultModelRehber(modelEditor.ModelKardanOrani, tip, Convert.ToInt32(row["rehber_id"])); 
                }
                else
                {
        ...
        {
            string sql =
                "select p.*, [rehber_id],[urunTipi] ,[normalSatisParite1],yuzdelik_tip ,[normalSatisParite2],[normalSatisYuzdelik],[kapiSatisParite1],[kapiSatisParite2] " +
                ...
                ",[yurtDisiSatisYuzdelik],[genelSatisParite1],[genelSatisParite2],[genelSatisYuzdelik] from  el_rehber p " +
