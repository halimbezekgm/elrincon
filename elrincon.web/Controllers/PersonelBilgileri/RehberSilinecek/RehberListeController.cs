...
{
    public class RehberListeController : RehberBaseController
    {
        // GET: RehberListe
        public ActionResult Index()
        {
            RehberListeModel model = new RehberListeModel();
            model.GridModel = FillGridModel(FillGridCustomProperties());
            model.RehberEditorModel = FillEditorModel();

            return View("~/Views/PersonelBilgileri/Rehber/RehberListe.cshtml", model);
        }

        private RehberEditorModel FillEditorModel()
        {
