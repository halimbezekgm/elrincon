...
{
    public class PersonelYuzdelikController : PersonelBaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Shared/KardanYuzdelikOranlariPersonel.cshtml", modelKardanOrani);
        }
        ...
        private ElDbTable GetTable()
        {
            string sql =
                ...
                "where yuzdelik_tip = 1 and personel_id = -2 ";
        ...
        {
            tableYuzdelik.Delete("yuzdelik_tip", 1); 
